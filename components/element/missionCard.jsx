...
const MissionCard = ({ missionTitle, image, description }) => {
  return (
    <div className="grid-rows-[auto_auto_1fr] xl:w-[50%] lg:pl-40 w-[100%] inline-grid gap-12 my-20 lg:px-20">
      <h2 className="text-center lg:text-left lg:row-start-2">
        {missionTitle}
      </h2>
      <div className=" w-[300px] lg:w-[420px] mx-auto lg:row-start-1 lg:mx-0">
