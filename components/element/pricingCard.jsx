const pricingCard = ({ data }) => {
  console.log(data)
  return (
    <article className="relative pricingCard xl:max-w-[354px] xl:min-w-[354px] flex-grow xl:shadow-md grid xl:grid-rows-[50px_100px_1fr] xl:grid-cols-[1fr] grid-rows-[auto_auto] grid-cols-[1fr_100px] gap-10 p-14">
