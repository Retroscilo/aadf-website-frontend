...
const SingleImageSection = ({ image, title, text, imageOnLeft }) => {
  ...
  return (
    <section className="max-w-[1500px] m-auto grid lg:grid-cols-[40%_50%] justify-between lg:grid-rows-[300px_300px] px-10 md:px-24 grid-rows-[200px_300px_200px] grid-cols-[1fr]">
