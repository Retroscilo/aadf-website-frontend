...
const DataEvent = ({ data, url, ...props }) => {
  ...
  return (
    <CustomLink url={url} newTab={false}>
      <div className="flex flex-col md:flex-row items-center gap-y-[30px] md:gap-y-0 md:items-stretch  md:gap-x-[13px] mb-4">
        <Image
          ...
          className="w-[199px] h-[127px] object-cover object-left-top md:flex-none"
        />
        <div className="flex flex-col text-center gap-y-[30px] md:gap-y-0 md:text-left md:justify-between max-w-[250px]">
          <p>{data.title}</p>
